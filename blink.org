...
This is to try and match exactly what various tutorials use. Several answers to questions have suggested that the specific version matters: https://github.com/krtkl/snickerdoodle-examples/issues/3
