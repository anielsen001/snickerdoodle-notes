...
** TODO Investigate difference between difference snickerdoodle boards in Vivado IDE setup.

 - go back and redo setup from scratch with generic snickerdoodle board.
